...
exports.executionEngine = exports.ExecutionEngine = void 0;
...
class ExecutionEngine {
     ...
     */
    async executeEvent(tenantId, event, data) {
     ...
     */
    async executeWorkflow(tenantId, workflow, data) {
    ...
    async executeStep(step, data) {
        ...
        for (const rule of rules) {
            const result = await (0, ruleEvaluator_1.evaluateRule)({
                id: rule.id,
                field: rule.field,
        ...
        if (!matchedRuleId) {
            const defaultRule = rules.find((r) => r.condition === 'DEFAULT' || r.field === 'DEFAULT');
            if (defaultRule) {
